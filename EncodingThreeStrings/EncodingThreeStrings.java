...
public class EncodingThreeStrings {
    ...
    public EncodingThreeStrings(int out1, int out2, int out3) {
        output1 = out1;
        output2 = out2;
        output3 = out3;
    }

    public EncodingThreeStrings(String output12, String output22, String output32) {
    }
    ...
    public class ThreeStrings {
        public static void main(String[] args) {
            ...
            EncodingThreeStrings rs = new EncodingThreeStrings(output1, output2, output3);
            System.out.print(rs);
        }
